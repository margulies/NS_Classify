...
dataset = Dataset.load("../data/datasets/abs_topics_filt_july.pkl")
...
for resolution in [3, 2]:
	...
	print "Downsampling..."
	cls_a = cluster.Clusterer(full_data, global_mask=dataset.masker, grid_scale = resolution)
	...
	for i in n_regions:
		print i
		cls_a.output_dir = '../results/cluster/cls_' + str(resolution) + 'mm_ward_coact/'
